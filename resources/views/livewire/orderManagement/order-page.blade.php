            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/defaultImage/order.png" alt="..." class="w-100 border-radius-lg shadow-sm">
                        {{--
                        <a href="javascript:;"
            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotification)
                    <div wire:model="showSuccesNotification"
                        ...
                        <span
                            class="alert-text text-white">{{ __('Your order information have been successfuly saved!') }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" placeholder="Order Number" value="{{ $order->name() }}"
                                        id="order-name" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="@error('order.status')border border-danger rounded-3 @enderror">
                                    <select wire:model="order.status" class="form-control" id="order-status">
                        ...
                        @foreach($order->orderProducts as $index => $orderProduct)
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <select class="form-control" id="product-{{ $index }}" wire:model="orderProducts.{{ $index }}.product_id" required>
                                ...
                                <div class="col-md-4">
                                    <label for="quantity-{{ $index }}" class="form-label mt-2">Quantity</label>
                                    <input type="number" class="form-control" id="quantity-{{ $index }}" wire:model="orderProducts.{{ $index }}.quantity" required>
                                </div>
                            </div>
                        @endforeach
                    </div>
