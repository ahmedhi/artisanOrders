                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input wire:model.live="user.name" class="form-control" type="text" placeholder="Name"
                                        id="user-name" @if($isSuperAdminViewing) readonly @endif>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.email')border border-danger rounded-3 @enderror">
                                    <input wire:model.live="user.email" class="form-control" type="email"
                                        placeholder="@example.com" id="user-email" @if($isSuperAdminViewing) readonly @endif>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input wire:model.live="user.phone" class="form-control" type="tel"
                                        placeholder="40770888444" id="phone" @if($isSuperAdminViewing) readonly @endif>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input wire:model.live="user.location" class="form-control" type="text"
                                        placeholder="Location" id="name" @if($isSuperAdminViewing) readonly @endif>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea wire:model.live="user.about" class="form-control" id="about" rows="3"
                                placeholder="Say something about yourself" @if($isSuperAdminViewing) readonly @endif></textarea>
                        </div>
